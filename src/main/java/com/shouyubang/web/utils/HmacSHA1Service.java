...
public class HmacSHA1Service {
	...
	public byte[] getSignature(String data, String key) throws Exception {
		return getSignature(data.getBytes(), key);
	}

	public byte[] getSignature(byte[] data, String key) throws Exception {
	...
	public String getFileSha1(String path) throws IOException {
