...
public class TlsSignatureUtil {
	...
	public static String getUserSig(String identifier){
		...
		try{			
		    ...
		    String privStr = ApiConstants.PRIVATE_KEY;

            // generate signature
            result = GenTLSSignatureEx(ApiConstants.SDK_APP_ID, identifier, privStr);
			...
			String privStr ) throws IOException
	{
		...
		try{
		   ...
		   // System.out.println("#jsonString : \n" + jsonString);
		    ...
		    String userSig = new String(Base64UrlUtil.base64EncodeUrl(Arrays.copyOfRange(compressBytes,0,compressBytesLength)));
			...
			String publicKey ) throws DataFormatException
	{
		...
		byte [] compressBytes = Base64UrlUtil.base64DecodeUrl(urlSig.getBytes(Charset.forName("UTF-8")));
